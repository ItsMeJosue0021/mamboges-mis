        ...
        <form action="{{ route('student.update', $student->id) }}" method="POST" class=""
            ...
            <div class="pb-6">
                ...
                <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 items-start md:space-x-4 ">
                    <div class="flex flex-col items-start justify-start w-full md:min-w-[330px] md:w-[500px]">
            ...
            <div class="w-full flex items-center justify-start">
                <button type="submit"
                    class="w-full md:w-fit text-center px-4 py-2 rounded text-white bg-blue-600 hover:bg-blue-700 poppins">Update</button>
            </div>
        </form>
    </div>
</x-guidance-layout>
