<div class="w-full flex items-center justify-between border border-gray-300 shadow rounded py-2 px-2 mb-3">
    <div class="w-full flex items-center space-x-4 rounded">
        <div class="w-fit flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
                <form id="PT_percentageForm"  method="POST" action="javascript::void(0)" class="flex items-center rounded py-2 px-2 border border-gray-300">
                    ...
                    <button id="PT_changePercentageButton" data-evaluation-id="{{ $evaluations->skip(1)->first()->id }}"  class="poppins text-xs text-white bg-sky-600 hover:bg-sky-700 px-2 py-1 font-bold rounded-[3px]">CHANGE</button>
                </form>
            </div>
        </div>
        ...
        <div class="w-fit flex items-center space-x-3 rounded py-2 px-2 border border-gray-300">
            ...
            <a id="new-pt-act" class="poppins text-xs font-bold text-white bg-emerald-600 hover:bg-emerald-700 px-2 py-1 rounded-[3px] cursor-pointer">NEW</a>
        </div>
    </div>
