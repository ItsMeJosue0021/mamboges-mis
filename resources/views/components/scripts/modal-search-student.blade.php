                    ...
                    if (data.length > 0) {
                        $.each(data, function (index, student) {
                            ...
                            var studentComponent = '<div class="flex justify-between space-x-6 px-2 py-2 border-t border-gray-300">' +
                                ...
                                '<p class="poppins text-base text-gray-700">' + student.firstName + ' ' + student.middleName + ' ' + student.lastName + '</p>' +
                                '</div>' +
                                '<div id="button-container">' +
                                '<button id="' + student.id + '" class="addstudentbtn poppins text-xs text-blue-500 py-1 px-2  border border-blue-500 hover:bg-blue-500 hover:text-white">Enroll</button>' +
                                '</div>' +
                                '</div>';
                    ...
                    if (data.studentCount > 0) {
                        $.each(data.students, function (index, student) {
                            ...
                            var studentComponent = '<div class="flex justify-between space-x-6 px-2 py-2 border-t border-gray-300">' +
                                ...
                                '</div>' +
                                '<div id="button-container">' +
                                '<button id="' + student.id + '" class="removestudentbtn poppins text-xs text-red-500 py-1 px-2  border border-red-500 hover:bg-red-500 hover:text-white">Remove</button>' +
                                '</div>' +
                                '</div>';
