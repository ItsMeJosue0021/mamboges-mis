        ...
        <div class="w-full flex items-start justify-center">
            <form action="{{ route('student.delete', $student->id) }}" method="POST"
                ...
                <div class="flex flex-col ">
                    <div class="mb-2">
                        <h1 class="poppins text-lg font-medium border-b border-gary-300 mb-2 text-red-500">You Are About To Remove A Learner</h1>
                        <p class="poppins text-sm text-left text-gray-600">Learner will be removed from the list of
