    ...
    <div id="container" class="w-full">
        ...
        <div class="h-auto px-4 overflow-auto w-full">
            <div class="h-full flex flex-col">
                <a class="flex justify-between py-1 px-2 border-b border-gray-300  items-center">
                    <p class="w-full poppins text-lg font-semibold">NAME</p>
                    <p class="w-full poppins text-lg font-semibold">HEAD</p>
                ...
                @foreach ($departments as $department)
                    <a class="w-full flex">
                        <div class="flex justify-between py-1 px-2 border-b border-gray-300 items-center">
        ...
        <div id="add-department-modal" class="hidden absolute top-0 left-0 w-full h-screen z-50">
            <div class="w-full h-full flex flex-col items-center justify-center space-y-6 px-4 md:px-32 py-8 bg-black bg-opacity-10">
                <form id="department-form" method="POST" action="/departments/save"
                    class="w-full md:w-[600px] flex flex-col space-y-3 bg-white p-8 pt-0 rounded-lg shadow-md">
                    @csrf
        ...
        <div id="delete-modal" class="hidden absolute top-0 left-0 w-full h-screen z-50">
            <div
                class="flex flex-col w-full h-full items-center justify-start space-y-6 bg-black bg-opacity-10 px-4">
        ...
        <div id="edit-department-modal" class="hidden absolute top-0 left-0 w-full h-screen z-50">
            <div class="w-full h-full flex flex-col items-center justify-center space-y-6 px-4 md:px-32 py-8 bg-black bg-opacity-10">
