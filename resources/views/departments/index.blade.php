<x-guidance-layout>
    <div id="container" class="w-full relative">
        ...
        <div class="flex justify-between items-center px-4 py-4 border-b border-gray-300">
            ...
            <div class="flex">
                <a id="add-department" class="poppins py-2 px-4 bg-blue-600 text-sm text-white font-medium rounded cursor-pointer">New Department</a>
            </div>
        </div>
        ...
        <div id="delete-modal" class="hidden absolute top-0 left-0 w-full h-full">
            <div class="flex flex-col w-full h-full items-center justify-start space-y-6 bg-black bg-opacity-10 ">
                <div class="flex flex-col p-4 rounded-md bg-white shadow-lg space-y-2 mt-60" id="delete-department-id">
        ...
        <div id="edit-department-modal" class="hidden absolute top-0 left-0 w-full h-full overflow-auto">
            <div class="w-full h-full flex flex-col items-center justify-center space-y-6 px-32 py-8 bg-black bg-opacity-10">
                ...
                <form id="edit-department-form" method="POST" action="javascript:void(0)"  class="w-full flex flex-col space-y-6 bg-white p-8 pt-0 rounded-lg shadow-md">
                    @csrf
                    @method('PUT')
                    <div class="w-full flex py-4">
...
<script src="{{ asset('js/department_index.js') }}"></script>