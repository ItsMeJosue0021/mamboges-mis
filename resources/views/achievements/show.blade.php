            ...
            <div class="flex flex-col md:flex-row items-start space-y-6 md:space-y-0 md:space-x-6 pt-6">
                <div class="w-full md:w-1/2">
                    <div class="flex flex-col space-y-8">
                        <div>
                            <h1 class="poppins text-3xl font-semibold title-font text-gray-900">
                ...
                <div class="w-full md:w-1/2">
                    <div class="flex flex-col space-y-4">
                        @foreach ($achievement->achievementImages as $images)
                            <img src="{{ asset('storage/' . $images->fileName) }}" alt=""
                                class="w-full rounded-md" data-aos="fade-up" data-aos-delay="500">
                        @endforeach
                    </div>
                </div>
            </div>
