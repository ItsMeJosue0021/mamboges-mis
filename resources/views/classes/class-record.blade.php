        ...
        <div class="w-full h-660px flex items-start p-2 overflow-auto">
            <form action="" class="w-full">
                ...
                <div class="w-full flex justify-between mb-2 space-x-2">
                    ...
                    <div class="w-3/4 ">
                        ...
                        <div class="flex space-x-2">
                            <div class="flex justify-center items-center  w-full py-4 bg-gray-100 cursor-pointer hover:bg-gray-300 border border-gray-300 rounded">
                ...
                <div class="eval-container">
                    <div id="written-works" class="w-full ">
