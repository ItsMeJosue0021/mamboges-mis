<x-guidance-layout>
    <div id="container" class="w-full relative">
        ...
        <div id="delete-modal" class="hidden absolute top-0 left-0 w-full h-screen">
            <div class="flex flex-col w-full h-full items-center justify-start space-y-6 bg-black bg-opacity-10 p-8">
