<div id="written" class="w-full ">
    ...
    <form action="{{ route('score.store') }}" method="POST" class="w-full ">
                ...
                <div class="w-3/4 flex justify-between">
                    ...
                    <div class="flex">
                        ...
                        <div class="w-[65px] flex justify-center items-center border-gray-400">
                            <p class="percentageValue_0 poppins font-semibold text-sm">{{$evaluations->first()->percentage}}%</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="w-full space-x-4 flex items-center mt-4">
            <button type="submit" class="poppins text-sm text-white bg-blue-700 hover:bg-blue-800 border border-blue-700 py-2 px-6 rounded">Save</button>
