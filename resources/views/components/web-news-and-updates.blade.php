    ...
    <div class="max-w-[1300px] mx-auto px-4">
        <div class="flex items-start space-x-4 justify-between py-24">
            ...
            <div class="w-[700px] flex flex-col space-y-2">
                <img alt="" src="{{$firstupdate->image ? asset('storage/' . $firstupdate->image) : asset('image/mamboges.jpg')}}"
                ...
                <div class="flex flex-col space-y-1 py-2">
                    ...
                    <p class="poppins text-sm text-gray-600 ">
                        {{substr($firstupdate->description, 0, 100)}}{{strlen($firstupdate->description) > 100 ? "..." : ""}}
                    </p>
            ...
            <div class="flex flex-col space-y-4">
                @foreach ($updates as $update)
                    <div class="flex items-center space-x-3">
                        <img alt="" src="{{$update->image ? asset('storage/' . $update->image) : asset('image/mamboges.jpg')}}"
