        ...
        <div class="w-fit flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
                <form id="percentageForm"  method="POST" action="javascript::void(0)" class="flex items-center rounded py-2 px-2 border border-gray-300">
                    ...
                    <button id="changePercentageButton" data-evaluation-id="{{ $evaluations->skip(1)->first()->id }}"  class="poppins text-xs text-white bg-blue-800 hover:bg-[#004080] px-2 py-1 font-bold rounded">CHANGE</button>
                </form>
            </div>
        </div>
