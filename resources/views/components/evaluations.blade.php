    ...
    <div class="w-3/4 ">
        <div class="flex space-x-2">
            @foreach ($evaluations as $key => $evaluation)
                <div class="h-28 flex evalnav {{ $key === 0 ? ' active-eval' : '' }} justify-center items-center  w-full py-4 cursor-pointer hover:bg-sky-800 shadow border border-gray-300 rounded-md group">
            ...
            @endforeach
            <div class="h-28 flex evalnav justify-center items-center w-full py-4 cursor-pointer hover:bg-sky-800 shadow border border-gray-300 rounded-md group">
                <div class="flex">
