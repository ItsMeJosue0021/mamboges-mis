<div class="w-full flex items-center justify-between border border-gray-200 shadow-md rounded py-2 px-2 mb-3">
    <div class="w-full flex items-center space-x-4 rounded">
        <div class="w-fit flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
                <form id="QA_PercentageForm"  method="POST" action="javascript::void(0)" class="flex items-center rounded py-2 px-2 border border-gray-300">
                    ...
                    <button id="QA_changePercentageButton" data-evaluation-id="{{ $evaluations->skip(2)->first()->id }}"  class="poppins text-xs text-white bg-blue-800 hover:bg-[#004080] px-2 py-1 font-bold rounded">CHANGE</button>
                </form>
            </div>
        </div>
        ...
        <div class="w-fit flex items-center space-x-3 rounded py-2 px-2 border border-gray-300">
            ...
            <a id="new-assessment" class="poppins text-xs font-bold text-white bg-green-800 px-2 py-1 rounded cursor-pointer">NEW</a>
        </div>
    </div>
