        ...
        <div class="w-fit flex items-center space-x-4">
            ...
            <div class="flex items-center space-x-2">
                <form id="QA_PercentageForm"  method="POST" action="javascript::void(0)" class="flex items-center rounded py-2 px-2 border border-gray-300">
                    ...
                    <button id="QA_changePercentageButton" data-evaluation-id="{{ $evaluations->skip(2)->first()->id }}"  class="poppins text-xs text-white bg-blue-600 hover:bg-blue-700 px-2 py-1 font-bold rounded-[3px]">CHANGE</button>
                </form>
            </div>
        </div>
