        ...
        <div id="container" class="w-full">
            ...
            <div id="add-facuty-modal" class="hidden absolute top-0 left-0 w-full h-screen z-50">
                <div class="w-full h-full flex flex-col items-center justify-center space-y-6 px-32 py-8 bg-black bg-opacity-10">
                    <form id="faculty-form" method="POST" action="javascript:void(0)" class="w-full flex flex-col space-y-2 bg-white p-8 pt-0 rounded-lg shadow-md">
                        @csrf
                            ...
                            <div class="flex flex-col space-y-2">
                                ...
                                <div class="w-full flex space-x-4">
                                    ...
                                    <div class="w-full flex flex-col space-y-1">
                                        <div class="flex items-baseline space-x-2">
                                            <label for="contact_no"
                                            class="poppins text-sm font-medium text-gray-600">Date Of Birth</label>
                                            <span class="error text-xs text-red-600"></span>
                                        </div>
